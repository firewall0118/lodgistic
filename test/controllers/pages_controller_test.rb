  ...
  describe "manager" do
    ...
    describe "GET#dashboard" do
      ...
      it "should load spend vs budgets data" do
        ...
        parsed_body['data']['budget'][0].must_equal 1000.0
        parsed_body['data']['budget'][1].must_equal 1650.0
        parsed_body['data']['spend'].count.must_equal 2
        parsed_body['data']['spend'][0].must_equal 1400.0
        parsed_body['data']['spend'][1].must_equal 800.0

        parsed_body['categories'].count.must_equal 2
        parsed_body['categories'][0].must_equal "CATEGORY1"
        parsed_body['categories'][1].must_equal "CATEGORY2"
      end
    end
  end
