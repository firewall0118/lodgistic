...
describe UsersController do
  ...
  describe "permissions" do
    ...
    describe "corporate" do
      ...
      describe "GET#edit" do
        ...
        it 'should not allow to edit invited user' do
          ...
          create(:join_hotel_invitation, property: Property.current, sender: user, invitee: invitee)
    ...
    describe "agm" do
      ...
      describe "POST#create" do
        it "agm should not have create access" do
          post :create, user: user_params.merge!("name" => "New User2")
          flash[:alert].must_equal "You are not authorized to access this page."
          assert_redirected_to authenticated_root_path
