...
describe 'Vendors Integration' do
  ...
  describe "procurement interfaces", js: true do
    ...
    it "should show procurement interface" do
      click_link('Procurement Interface')
      page.text.must_include('VPT (US Foods)')
      page.text.must_include('Punchout')
    end

    it "should show VPT fields and vpt enabled flag" do
      click_link('Procurement Interface')
      page.text.must_include('VPT (US Foods)')
      page.text.must_include('Punchout')
