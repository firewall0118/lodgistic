...
describe 'Corporate Integration' do
  ...
  it "corporate flow", js: true do
    ...
    sleep 0.5
    find('a', text: "CORP1").trigger(:click)
    # find('ul.dropdown-menu[role="menu"] li a', text: 'PROPERTY1').trigger(:click)
    ...
    # returning back to corporate:
    find('a', text: "PROPERTY1").trigger(:click) # open dropdown
    find('a', text: "CORP1").trigger(:click) # clicking on corp
    sleep 1
    current_path.must_equal corporate_root_path
    page.body.must_include "CORP1"
  end
  ...
  it 'connects hotel to corporate', js: true do
    ...
    find('a', text: 'Connect to Corporate').trigger(:click)
    sleep 1
    # screenshot_and_open_image
  ...
  it 'should allow corporate to confirm connection', js: true do
    ...
    sleep 1
    find(".nav li:nth-child(3) > a.dropdown-toggle", visible: false).trigger(:click)
    ...
    # screenshot_and_open_image
    page.body.wont_include "Review"
    page.body.must_include property.name
    page.body.must_include "Confirmed"
  end
  ...
  it 'should not allow to edit declined by corporate connection', js: true do
    ...
    page.body.must_include "Rejected by Corporate"
    page.body.wont_include "Review"
  end
