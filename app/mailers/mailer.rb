class Mailer < ActionMailer::Base
  ...
  def join_hotel_invitation(invitation_id)
    @invitation = JoinHotelInvitation.find invitation_id
    mail(to: @invitation.invitee.email, subject: "Lodgistics | Invitation to join hotel #{@invitation.property.name}")
  end
